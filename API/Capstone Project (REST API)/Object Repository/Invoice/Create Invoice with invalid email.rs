...
<WebServiceRequestEntity>
   ...
   <name>Create Invoice with invalid email</name>
   <tag></tag>
   <elementGuidId>6add85f7-3de1-4465-be46-f34f72aa9b89</elementGuidId>
...
assertThat(response.getResponseText()).contains('email client invalid')</verificationScript>
