...
<WebServiceRequestEntity>
   ...
   <name>Create Invoice with empty client name</name>
   <tag></tag>
   <elementGuidId>3033814c-f529-4fd7-b074-39b72127efea</elementGuidId>
...
assertThat(response.getResponseText()).contains('empty client name')
</verificationScript>
