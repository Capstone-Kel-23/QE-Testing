...
<WebServiceRequestEntity>
   ...
   <name>Create Invoice with wrong sub total payment</name>
   <tag></tag>
   <elementGuidId>4d55341d-140a-4861-a3d5-d7e0c39d1102</elementGuidId>
...
assertThat(response.getResponseText()).contains('success create invoice')


assertThat(response.getResponseText()).contains('INV-0782667873215')</verificationScript>
