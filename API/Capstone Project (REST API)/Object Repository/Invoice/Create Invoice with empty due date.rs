...
<WebServiceRequestEntity>
   ...
   <name>Create Invoice with empty due date</name>
   <tag></tag>
   <elementGuidId>888cd86f-2ab4-42b8-8ac5-8688abf0ce18</elementGuidId>
...
assertThat(response.getResponseText()).contains('Error 1292: Incorrect datetime value: 0000-00-00 for column date_due at row 1')
</verificationScript>
