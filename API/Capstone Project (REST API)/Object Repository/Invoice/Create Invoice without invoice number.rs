...
<WebServiceRequestEntity>
   ...
   <name>Create Invoice without invoice number</name>
   <tag></tag>
   <elementGuidId>0b15c633-6537-4e28-af05-f96642fe585c</elementGuidId>
...
assertThat(response.getResponseText()).contains('invoice number empty')</verificationScript>
