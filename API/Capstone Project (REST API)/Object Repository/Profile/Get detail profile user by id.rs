...
<WebServiceRequestEntity>
   ...
   <name>Get detail profile user by id</name>
   <tag></tag>
   <elementGuidId>9103e934-06ca-4a86-8c33-dc086609a6db</elementGuidId>
...
assertThat(response.getResponseText()).contains('success get profile user')</verificationScript>
